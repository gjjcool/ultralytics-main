...
def main():
    ...
    model = YOLO("runs/server/train10/weights/best.pt")  # load a pretrained model (recommended for training)

    input_dir = r'D:\Resources\Projects\qhx_ocr\input\labelled_C\dataset_yolo_tmp\images\test'
    output_dir = r'D:\Resources\Projects\qhx_ocr\output\c_utter\test'
    no_dir = r'D:\Resources\Projects\qhx_ocr\output\c_utter\test\no'
