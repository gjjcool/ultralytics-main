...
def init_args():
    ...
    parser.add_argument("--det_limit_side_len", type=float, default=1280)  # changed
    parser.add_argument("--det_limit_type", type=str, default='max')
    parser.add_argument("--det_box_type", type=str, default='quad')

    # DB parmas
    parser.add_argument("--det_db_thresh", type=float, default=0.3)
    parser.add_argument("--det_db_box_thresh", type=float, default=0.3)  # changed (default: 0.6)
    ...
    parser.add_argument(
        "--rec_char_dict_path",
        type=str,
        default="./PaddleOCR/ppocr/utils/ppocr_keys_v1.txt")  # changed
