...
celery_app_3 = Celery('celery_app_3', broker='redis://localhost:6379/3', backend='redis://localhost:6379/3')


@celery_app_3.task(name='celery_apps.celery_app_3.predict_bt')
