...
celery_app_6 = Celery('celery_app_6', broker='redis://localhost:6379/6', backend='redis://localhost:6379/6')


@celery_app_6.task(name='celery_apps.celery_app_6.predict_bt')
