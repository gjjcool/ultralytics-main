...
celery_app_2 = Celery('celery_app_2', broker='redis://localhost:6379/2', backend='redis://localhost:6379/2')


@celery_app_2.task(name='celery_apps.celery_app_2.predict_bt')
