...
celery_app_1 = Celery('celery_app_1', broker='redis://localhost:6379/1', backend='redis://localhost:6379/1')


@celery_app_1.task(name='celery_apps.celery_app_1.predict_bt')
