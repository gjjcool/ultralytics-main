...
celery_app_5 = Celery('celery_app_5', broker='redis://localhost:6379/5', backend='redis://localhost:6379/5')


@celery_app_5.task(name='celery_apps.celery_app_5.predict_bt')
