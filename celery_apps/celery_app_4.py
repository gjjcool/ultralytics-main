...
celery_app_4 = Celery('celery_app_4', broker='redis://localhost:6379/4', backend='redis://localhost:6379/4')


@celery_app_4.task(name='celery_apps.celery_app_4.predict_bt')
